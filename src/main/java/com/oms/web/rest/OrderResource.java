...
/**
 * REST controller for managing {@link com.oms.domain.Order}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class OrderResource {
    ...
    public ResponseEntity<List<Order>> getAllOrdersByOrderStatus(Pageable pageable,@PathVariable OrderStatus orderStatus) {
